...
It is a multi-dimensional regression task beacause we have 8 quantitative independent variables, and the problem is to predict the values of Y given X1,...X8.
...
The table represents the values of the MSE on dataset depending on the parameter α for the 3 models. We test these 3 different regularizations : Ridge (α = 0), lasso (α = 1) and elasticNet where the value of α is determined by cross validation.
...
After training, the best C and sigma for this model are `10` and `0.1` respectively.
